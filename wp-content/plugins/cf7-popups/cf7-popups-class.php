    ...
    class CF7_POPUPS {
        ...
        */
        ...
        function cf7_poppus_notice(){
            ...
            if ( get_option('dismissed-notice-upgrade-cf7pp-cww', FALSE ) ) { 
                return;
            }
            
            if(! class_exists('CF7_Power_Pack') ){
                ?>
                <div class="notice-upgrade-cf7pp updated notice is-dismissible" data-notice="notice-upgrade-cf7pp-cww">
                    <p>
